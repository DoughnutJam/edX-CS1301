...
def generate_name(filename, person_name):
    ...
    firstname_letter = split_name[0][0]
    lastname_letter = split_name[1][0]

    with open(filename, mode="r") as file:
        content = [line.rstrip() for line in file]
        fname_hero_index = ord(firstname_letter) - 65
        lname_hero_index = ord(lastname_letter) - 39
        fname_hero = content[fname_hero_index]
        lname_hero = content[lname_hero_index]
        hero_name = fname_hero+" "+lname_hero
